	...
	def splitMerge(self):
		...
		for i in range(self.slices):
			...
			for imgname in train_imgs:
				midname = imgname[imgname.replace("\\","/").rindex("/")+1:imgname.rindex("."+self.img_type)]
...
class dataProcess(object):
	...
	def create_train_data(self):
		...
		for imgname in imgs:
			midname = imgname[imgname.replace("\\","/").rindex("/")+1:]
	...
	def load_train_data(self):
		...
		# saving the mean value
		#print(mean)
		#imgmean = np.array([mean])
		#np.save(self.npy_path+"/img_mean.npy", imgmean)
	...
	def load_test_data(self):
		...
		# load mean of train imgs
		#imgmean = np.load(self.npy_path+"/img_mean.npy")
		#mean = imgmean[0]
